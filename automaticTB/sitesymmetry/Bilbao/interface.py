...
class PointGroupData:
    ...
    reference_real_file_yaml = os.path.join(rootfolder, "sitesymmetry", "Bilbao", "reference", "real.yaml")
    reference_complex_file_yaml = os.path.join(rootfolder, "sitesymmetry", "Bilbao", "reference", "complex.yaml")
