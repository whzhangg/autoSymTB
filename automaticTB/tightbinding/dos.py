# basically, the sub package here should be able to calculate the 
# dos and bandstructure given a tight-binding model. 
# bandstructure, dos result is output through dataclass as well as matplotlib

# this script accept a band structure (nscf) and calculates density of states
# different methods can be used, including a smearing version and a tetrahedron version
# the tetrahedron version is adopted from https://github.com/tflovorn/tetra
# including the optimizeGs() and dos_contribution()
